...
public class AuthorizationServiceTest {
    ...
    void setUp() {
        ...
        authorizationService = new AuthorizationServiceImpl(userRepository, securityConfig, userAuthCache, userMapper);
    ...
    void authUser_whenNewUserSetValidPass() {
        UserEntity userEntityFromDB = userMapper.toEntityFromShortDto(correctUserShortTO, LocalDateTime.now());
    ...
    void notAuthUser_whenNewUserSetNotValidPass() {
        UserEntity userEntityFromDB = userMapper.toEntityFromShortDto(
