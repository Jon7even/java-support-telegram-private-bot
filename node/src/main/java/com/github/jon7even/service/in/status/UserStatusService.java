 ...
 * с chatId (который присваивается Telegram) и по ключу доставать необходимые статусы. При подключении Redis следует
 * учесть следующий момент: сервис Node может запускаться в неограниченном количестве копий.
 */
