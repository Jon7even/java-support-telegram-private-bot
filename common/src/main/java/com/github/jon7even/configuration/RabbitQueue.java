...
/**
 * Утилитарный класс возможных типов названия очередей для RabbitMQ.
 *
 * @author Jon7even
 * @version 2.0
 ...
 * оперативно вносить изменения и реализовывать новый функционал. Если из конфигурации будет решено удалить ненужные,
 * следует удалить и с этого класса тоже.
 */
